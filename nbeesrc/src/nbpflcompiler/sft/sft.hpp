...
template <class SType, class LType, class PType = bool, class AType = std::string, class VType = uint32, class SPType = std::string>
class sftFsa
{
...
public:
  ...
  public:		    	
    	void RemoveEdge()
    	{
    		this->Owner->m_Graph.arc_erase(Edge);
    	}
  ...
  /************************************************************/
    ...
    //ExtendedTransition constructor 
    ...
    {    
      ...
      tr->addRange(op, v, out_1,stringPredicate); //add the true transition
...
public:
  ...
  */
  ...
  /*!
    \brief Copy Constructor
  */
  sftFsa(sftFsa<SType, LType, PType, AType, VType, SPType> &other);
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
sftFsa<SType, LType, PType, AType, VType, SPType>::sftFsa(typename sftFsa<SType, LType, PType, AType, VType, SPType>::Alphabet_t &alphabet)
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
sftFsa<SType, LType, PType, AType, VType, SPType>::sftFsa(sftFsa<SType, LType, PType, AType, VType, SPType> &other)
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
sftFsa<SType, LType, PType, AType, VType,SPType>::~sftFsa()
{
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
typename sftFsa<SType, LType, PType, AType, VType, SPType>::StateIterator sftFsa<SType, LType, PType, AType, VType, SPType>::AddState(SType info)
{
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
typename sftFsa<SType, LType, PType, AType, VType, SPType>::StateIterator sftFsa<SType, LType, PType, AType, VType, SPType>::AddState(State& other)
{
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
void sftFsa<SType, LType, PType, AType, VType, SPType>::removeState(State* state)
{
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
typename sftFsa<SType, LType, PType, AType, VType, SPType>::TransIterator sftFsa<SType, LType, PType, AType, VType, SPType>::AddTrans(StateIterator &from, StateIterator &to, Transition *trans)
{
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
typename sftFsa<SType, LType, PType, AType, VType, SPType>::TransIterator sftFsa<SType, LType, PType, AType, VType, SPType>::AddTrans(StateIterator &from, StateIterator &to,  LType lbl, bool complement, PType pred)
{
  ...
  for(typename Graph_t::arc_vector::iterator i = arcs_out.begin();
      ...
      i++)
  {
    // see if this transition is ok for the optimization (same target state, same predicate, not an epsilon-transition)
    if(m_Graph.arc_to(*i) == (*to).Node && (**i)->Predicate == pred && !(**i)->Epsilon)
    {
      if(complement){
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
typename sftFsa<SType, LType, PType, AType, VType, SPType>::TransIterator sftFsa<SType, LType, PType, AType, VType, SPType>::AddTrans(StateIterator &from, StateIterator &to,  Alphabet_t &labels, bool complement, PType pred)
{
  assert((*from).Owner == this);
  assert((*to).Owner == this);
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
typename sftFsa<SType, LType, PType, AType, VType, SPType>::TransIterator sftFsa<SType, LType, PType, AType, VType, SPType>::AddTrans(StateIterator from,
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
typename sftFsa<SType, LType, PType, AType, VType, SPType>::TransIterator sftFsa<SType, LType, PType, AType, VType, SPType>::AddEpsilon(StateIterator &from, StateIterator &to, PType pred)
{
  assert((*from).Owner == this);
  assert((*to).Owner == this);
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
typename sftFsa<SType, LType, PType, AType, VType, SPType>::ExtendedTransition* sftFsa<SType, LType, PType, AType, VType, SPType>::addExtended
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
void sftFsa<SType, LType, PType, AType, VType, SPType>::SetInitialState(StateIterator &st)
{
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
void sftFsa<SType, LType, PType, AType, VType, SPType>::setAccepting(StateIterator &st)
{
  assert((*st).Owner == this);
  State *s = &(*st);
  s->setAccepting(true);
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
void sftFsa<SType, LType, PType, AType, VType, SPType>::resetAccepting(StateIterator &st)
{
  assert((*st).Owner == this);
  State *s = &(*st);
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
void sftFsa<SType, LType, PType, AType, VType,SPType>::setFinal(StateIterator &st)
{
  assert((*st).Owner == this);
  State *s = &(*st);
  s->setFinal(true);
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
void sftFsa<SType, LType, PType, AType, VType, SPType>::resetFinal(StateIterator &st)
{
  assert((*st).Owner == this);
  State *s = &(*st);
  s->setFinal(false);
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
typename sftFsa<SType, LType, PType, AType, VType, SPType>::StateIterator sftFsa<SType, LType, PType, AType, VType, SPType>::GetInitialState(void)
{
  return StateIterator(m_Graph, m_InitialState->Node);
}

template <class SType, class LType, class PType, class AType, class VType, class SPType>
typename sftFsa<SType, LType, PType, AType, VType, SPType>::StateIterator sftFsa<SType, LType, PType, AType, VType, SPType>::FirstState(void)
{
  return StateIterator(m_Graph);
}

template <class SType, class LType, class PType, class AType, class VType, class SPType>
typename sftFsa<SType, LType, PType, AType, VType, SPType>::StateIterator sftFsa<SType, LType, PType, AType, VType,SPType>::LastState(void)
{
  return StateIterator(m_Graph, true);
}

template <class SType, class LType, class PType, class AType, class VType, class SPType>
typename sftFsa<SType, LType, PType, AType, VType, SPType>::TransIterator sftFsa<SType, LType, PType, AType, VType, SPType>::FirstTrans(void)
{
  return TransIterator(m_Graph);
}

template <class SType, class LType, class PType, class AType, class VType, class SPType>
typename sftFsa<SType, LType, PType, AType, VType, SPType>::TransIterator sftFsa<SType, LType, PType, AType, VType, SPType>::LastTrans(void)
{
  return TransIterator(m_Graph, true);
}

template <class SType, class LType, class PType, class AType, class VType, class SPType>
void sftFsa<SType, LType, PType, AType, VType, SPType>::ResetVisited(void)
{
  Node_t st_it;
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
typename sftFsa<SType, LType, PType, AType, VType, SPType>::StateList_t sftFsa<SType, LType, PType, AType, VType, SPType>::GetAllStates(void)
{
	StateList_t stateList;
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
typename sftFsa<SType, LType, PType, AType, VType, SPType>::StateList_t sftFsa<SType, LType, PType, AType, VType, SPType>::SortRevPostorder(void)
{
	StateList_t statelist;
	this->ResetVisited();
...
template <class SType, class LType, class PType, class AType, class VType, class SPType> 
typename sftFsa<SType, LType, PType, AType, VType, SPType>::StateList_t sftFsa<SType, LType, PType, AType, VType, SPType>::SortPostorder(void)
{
	StateList_t statelist;
	this->ResetVisited();
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
typename sftFsa<SType, LType, PType, AType, VType, SPType>::StateList_t sftFsa<SType, LType, PType, AType, VType, SPType>::SortPreorder(void)
{
	StateList_t statelist;
	this->ResetVisited();
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
typename sftFsa<SType, LType, PType, AType, VType, SPType>::StateList_t sftFsa<SType, LType, PType, AType, VType, SPType>::SortRevPreorder(void)
{
	StateList_t statelist;
	this->ResetVisited();
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
void sftFsa<SType, LType, PType, AType, VType, SPType>::DFSPreorder(State &state, StateList_t &sortedStates)
{
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
void sftFsa<SType, LType, PType, AType, VType, SPType>::DFSPostorder(State &state, StateList_t &sortedStates)
{
	if (state.HasBeenVisited())
		return;
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
void sftFsa<SType, LType, PType, AType, VType, SPType>::DFSReversePreorder(State &state, StateList_t &sortedStates)
{
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
void sftFsa<SType, LType, PType, AType, VType, SPType>::DFSReversePostorder(State &state, StateList_t &sortedStates)
{
	if (state.HasBeenVisited())
		return;
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
std::list<typename sftFsa<SType, LType, PType, AType, VType, SPType>::Transition*> sftFsa<SType, LType, PType, AType, VType, SPType>::getTransExitingFrom(State *state)
{
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
std::list<typename sftFsa<SType, LType, PType, AType, VType, SPType>::Transition*> sftFsa<SType, LType, PType, AType, VType, SPType>::getTransEnteringTo(State *state)
{
  std::list<Transition*> result;
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
std::list<typename sftFsa<SType, LType, PType, AType, VType, SPType>::Transition*> sftFsa<SType, LType, PType, AType, VType, SPType>::getTransExitingFrom(State *state, LType label)
{
  std::list<Transition*> result;
  typename Graph_t::arc_vector arcs_out = m_Graph.outputs(state->Node);
  for(typename Graph_t::arc_vector::iterator i = arcs_out.begin();
...
template <class SType, class LType, class PType, class AType, class VType, class SPType>
void sftFsa<SType, LType, PType, AType, VType, SPType>::compactStates(map<State*, State*> mappings,
